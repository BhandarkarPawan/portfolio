...
exports.modules = {
  /***/ 1297: /***/ function (
    ...
    /* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_1___default =
      /*#__PURE__*/ __webpack_require__.n(
        date_fns__WEBPACK_IMPORTED_MODULE_1__
      );

    function Date({ dateString }) {
      const date = (0, date_fns__WEBPACK_IMPORTED_MODULE_1__.parseISO)(
        dateString
      );
      return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(
        ...
        {
          dateTime: dateString,
          children: (0, date_fns__WEBPACK_IMPORTED_MODULE_1__.format)(
            date,
            'LLLL d, yyyy'
          ),
        }
  ...
  /***/ 4025: /***/ function (
    ...
    'use strict';
    /* harmony export */ __webpack_require__.d(__webpack_exports__, {
      /* harmony export */ ld: function () {
        return /* binding */ getSortedPostsData;
      },
      /* harmony export */ Le: function () {
        return /* binding */ getAllPostIds;
      },
      /* harmony export */ AU: function () {
        return /* binding */ getPostData;
      },
      /* harmony export */
    });
    ...
    /* harmony import */ var gray_matter__WEBPACK_IMPORTED_MODULE_2___default =
      /*#__PURE__*/ __webpack_require__.n(
        gray_matter__WEBPACK_IMPORTED_MODULE_2__
      );
    ...
    const postsDirectory = path__WEBPACK_IMPORTED_MODULE_1___default().join(
      process.cwd(),
      'posts'
    );
    function getSortedPostsData() {
      ...
      const allPostsData = fileNames.map((fileName) => {
        ...
        const fullPath = path__WEBPACK_IMPORTED_MODULE_1___default().join(
          postsDirectory,
          fileName
        );
        const fileContents =
        ...
        const matterResult =
          gray_matter__WEBPACK_IMPORTED_MODULE_2___default()(fileContents); // Combine the data with the id
    ...
    function getAllPostIds() {
      const fileNames =
        fs__WEBPACK_IMPORTED_MODULE_0___default().readdirSync(postsDirectory);
      const staticPaths = fileNames.map((fileName) => {
        return {
          params: {
    ...
    async function getPostData(id) {
      ...
      const matterResult =
        gray_matter__WEBPACK_IMPORTED_MODULE_2___default()(fileContents); // Use remark to convert markdown into HTML string
